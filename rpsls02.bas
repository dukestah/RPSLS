...
35 INPUT"no of players (max 10):";N
36 IF N>10THENPRINT"too many!":GOTO 35
40 FORX=0TON-1
...
510 LP=0:P1=0:P2=0
520 POKE2046,197:FORY=0TO2:FORX=0TO30:NEXT:POKE2046,198+Y:NEXT
...
570 FORX=0TO30:NEXTX:FORX=0to5:POKE2040+X,200:POKEV+39+X,1:NEXTX
571 PY=20:PX=1:GOSUB3000:FORX=0TON-1:PRINTN(X);:NEXT
572 IFFR=1THENNEXTO2:NEXTO1
580 GOTO478

600 PRINT CHR$(147):PRINT"the end"
610 

998 PRINT CHR$(147):FORX=0TON-1:PRINTN(X):NEXT
999 END
1000 REM STONE
1020 DATA 0,0,0
1030 DATA 0,0,0
